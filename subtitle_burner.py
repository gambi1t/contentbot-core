...
_BRAND_CANONICAL: dict[str, str] = {
    ...
    "v8":          "V8",
    "v7":          "V7",
    # GPT family (расширено 3 июня 2026 для selfie pipeline)
    "gpt5":        "GPT-5",
    "гпт5":        "GPT-5",
    "джипити5":    "GPT-5",
    # Claude family (Opus/Sonnet/Haiku — варианты Whisper)
    "opus":        "Opus",
    "опус":        "Opus",
    "sonnet":      "Sonnet",
    "соннет":      "Sonnet",
...
def transcribe_words(
    ...
    Args:
        initial_prompt: optional context string passed to faster-whisper as
            transcription prompt. Used for vocabulary biasing — pass a comma-
            separated list of expected brand names ("ChatGPT, Claude, ...") to
            improve recognition of mis-heard English terms. Default ``None``
            preserves the legacy behaviour (no biasing).
    """
