...
PIPELINES = [
    ...
    },
    {
        ...
        "status": "done",
        "summary": "Селфи + фото и видео из архива (или загруженные на ходу) поверх лица — формат Hormozi-style.",
        "steps": [
            "Шаги 1-3 — как в Pipeline 2 (запись, распознавание, правка).",
            "После прожига субтитров бот спрашивает: «🎬 Добавить B-roll-вставки?».",
            "Picker с 4 источниками: 📷 фото из библиотеки (113 шт), 🎞 клипы из библиотеки (80 шт), 📤 загрузить своё фото, 📤 загрузить своё видео.",
            "Можно набрать до 7 вставок в любой комбинации. Счётчик и список выбранных видны.",
            "По «Готово» бот собирает финальный ролик: видео-вставки крутятся полную длину поверх селфи (звук остаётся твой), фото — Ken Burns 2.8 сек как 50/50.",
            "Дальше — музыка, обложка, 5 хуков, Notion, публикация (как в Pipeline 2).",
        ],
        "tech": "Переиспользует video_assembler.assemble_auto_montage(layout='smart') — тот же движок что у Pipeline 4 с аватаром. 30 unit-тестов на pure helpers + Telethon E2E. Закончен 8 июня 2026.",
    },
    {
        "n": 4,
...
def build_cover(story: list) -> None:
    ...
    story.append(Paragraph("Обзор пайплайнов на 8 июня 2026", SUBTITLE))
