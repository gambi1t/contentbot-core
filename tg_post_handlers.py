...
def _kb_type_picker() -> InlineKeyboardMarkup:
    # Menu layout 2026-04-21:
    # • «Про эксперимент» — веха, новый этап (старый "stage").
    # • «Пост к ролику» — длинный пост в канал вдогонку к готовому видео
    #   (старый "video_companion").
    # • «Мысль / наблюдение» — короткий свободный пост без привязки к
    #   ролику или этапу (новый тип "thought").
    # «Вводный пост» (intro) убран из меню — он уже написан и живёт в канале,
    # повторно не нужен. Промпт для intro оставлен в writer на случай возврата.
