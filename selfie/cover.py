...
Три источника (по итогам обсуждения 4 июня 2026):
  ...
  - library: 6 случайных фото из /root/content-bot/broll-library/photos
             с пагинацией «🔄 Ещё 6»
...
# Серверный путь к фото-библиотеке. На dev-машине его нет — модуль импортируется
# нормально, но list_library_sample вернёт пустой список.
_LIBRARY_DIR = Path("/root/content-bot/broll-library/photos")
