...
4. callback приходит на https://bot.panferov-ai.ru/oauth/callback (nginx
...
- Meta Developer App (ID: 921654167162123) с настройками:
  ...
  - Redirect URI: https://bot.panferov-ai.ru/oauth/callback
...
def main():
    ...
    print()
    print("Callback придёт на https://bot.panferov-ai.ru/oauth/callback")
